...
#choice1: float(input("선택 첫 번째 과목 점수를 입력: "))
#choice2: float(input("선택 두 번째 과목 점수를 입력: "))
...
#print("회원님꼐서 지급하실 총 금액은", price, "원 입니다.")
